...
from isegm.data.datasets import GrabCutDataset, BerkeleyDataset, DavisDataset, SBDEvaluationDataset, PascalVocDataset, TETRISDataset
...
def get_dataset(dataset_name, cfg, args):
    if dataset_name == 'GrabCut':
        ...
        dataset = PascalVocDataset(cfg.PASCALVOC_PATH, args, split='test')
